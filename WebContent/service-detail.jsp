...
<body>
    <div class="card">
        ...
        <c:if test="${not empty service}">
            <p><strong>Code:</strong> <c:out value="${service.code}"/></p>
            <p><strong>Name:</strong> <c:out value="${service.name}"/></p>
            <p><strong>Description:</strong> <c:out value="${service.description}"/></p>
            <p><strong>Duration:</strong> ${service.durationMin} minutes</p>
            <p><strong>Base Price:</strong> $<fmt:formatNumber value="${service.basePrice}" pattern="#,##0.00"/></p>
        </c:if>
