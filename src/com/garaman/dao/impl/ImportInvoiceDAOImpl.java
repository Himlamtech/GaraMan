...
public class ImportInvoiceDAOImpl implements ImportInvoiceDAO {
    ...
    public void updateTotalAmount(int invoiceId, double amount) {
        String sql = "UPDATE tbl_import_invoice SET totalAmount = ?, finalAmount = ? WHERE invoiceId = ?";
    ...
    @Override
    public void updateDiscount(int invoiceId, int discountId, double discountAmount, double finalAmount) {
        String sql = "UPDATE tbl_import_invoice SET discountId = ?, discountAmount = ?, finalAmount = ? WHERE invoiceId = ?";
